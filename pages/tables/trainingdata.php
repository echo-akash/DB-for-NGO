            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT concat(INITCAP(F_name),INITCAP(L_Name)),Training_Name,Org_Name,Org_Addr,Trainingresult,Duration,Trainingsession FROM Person,TrAINING WHERE Person.Person_Id=Training.Person_Id');
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
