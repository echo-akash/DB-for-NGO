            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT concat(INITCAP(F_name),INITCAP(L_Name)),Type_of_Donar,Donation_type,Date_of_Donation,Donation_Amount FROM Donar,Person WHERE Donar.Person_Id=Person.Person_Id');
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
