            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT Person_Id,Ref_id,Ref_name,Ref_email,Ref_Phone_No,RefAddress.house,RefAddress.road,RefAddress.City,RefAddress.country,RefAddress.postal_code FROM Ref_relation');
                    oci_execute($stid);
