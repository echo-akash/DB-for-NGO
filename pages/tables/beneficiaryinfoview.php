...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Tables
        <small>Beneficiary Personal Information</small>
      </h1>
    ...
    <section class="content">
      ...
      <div class="col-sm-4 invoice-col">
        <big><b>Beneficiary general Information</b></big>
        <address>
                  <?php  
                    $E_Id = $_POST['CkPersonid'];
                    $GenVal1 = array("<b>Beneficiary ID</b>", "<b>First Name</b>", "<b>First Name</b>", "<b>Date of Birth</b>", "<b>Gender</b>", "<b>Religion</b>", "<b>Nationality</b>");
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        <big><b>Identification Information</b></big>
        <address>
                  <?php  
                    $E_Id = $_POST['CkPersonid'];
