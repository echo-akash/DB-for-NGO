            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT Health_Proj.P_Id,Project.P_Name,Project.City,Project.Start_Date,Project.Budget,Project.P_Fund  FROM Project,Health_Proj WHERE Project.P_Id=Health_Proj.P_Id');
                    oci_execute($stid);
