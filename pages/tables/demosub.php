          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php  
                    $q="SELECT Person_id,type from Current_job   natural JOIN Person_Project natural JOIN Project  WHERE P_id=(SELECT P_Id FROM Women_Emp_Seminar WHERE Seminar_Subj='Empower' )
";
