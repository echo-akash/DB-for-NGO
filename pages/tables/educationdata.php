            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT concat(INITCAP(F_name),INITCAP(L_Name)),Exam_Name,Passing_Yr,Examresult,ExamGroup,Board_university,Inst_University,Examsession FROM EDUCATION_QUAL,Person WHERE Person.Person_Id=Education_Qual.Person_Id');
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
