            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT Volunteer.Person_Id,INITCAP(Person.F_Name),INITCAP(Person.L_Name),Person.DOB FROM Volunteer,Person WHERE Person.Person_Id=Volunteer.Person_Id ');
                    oci_execute($stid);
