            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT Women_Emp_Seminar.P_Id,Project.P_Name,Project.City,Project.Start_Date,Project.Budget,Project.P_Fund  FROM Project,Women_Emp_Seminar WHERE Project.P_Id=Women_Emp_Seminar.P_Id');
                    oci_execute($stid);
