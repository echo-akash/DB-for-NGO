            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT INITCAP(P_Name),Branch_Project.P_Id,Br_Name,Branch_Project.Br_id FROM Branch_Project,Branch,Project WHERE Branch_Project.P_Id=Project.P_Id AND Branch.Br_Id=Branch_Project.Br_ID');
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
