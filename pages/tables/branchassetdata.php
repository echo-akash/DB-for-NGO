            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT INITCAP(Br_Name),Asset_Type,Buying_Date,Quantity,Total_Price FROM Assets,Branch_Asset,Branch WHERE Assets.Asset_Id=Branch_Asset.Asset_Id AND Branch.Br_Id=Branch_Asset.Br_Id');
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
