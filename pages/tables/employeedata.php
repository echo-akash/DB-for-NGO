  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT Employee.Person_Id,INITCAP(Person.F_Name),INITCAP(Person.L_Name),Person.DOB, Person.City FROM Employee,Person WHERE Person.Person_Id=Employee.Person_Id');
                    oci_execute($stid);
        ...
        <div class="col-xs-12">
          <a href="../examples/employeeprintoption.php" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
