...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Tables
        <small>Person Project Assignment</small>
      </h1>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php  
                    $q = "SELECT Person_Project.Person_Id,concat(F_Name,L_Name),Person_Project.P_Id,Project.P_Name FROM Project,Person,Person_Project WHERE Person.Person_Id=Person_Project.Person_Id AND Project.P_Id=Person_Project.P_id";
