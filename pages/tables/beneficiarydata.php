          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php  
                    $q="SELECT Beneficiaries.Person_Id,INITCAP(Person.F_Name),INITCAP(Person.L_Name),Person.DOB,ROUND((current_date-DOB)/360) FROM Beneficiaries,Person WHERE Person.Person_Id=Beneficiaries.Person_Id";
