            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT Donar.Person_Id,INITCAP(Person.F_Name),INITCAP(Person.L_Name),Person.DOB FROM Donar,Person WHERE Person.Person_Id=Donar.Person_Id');
                    oci_execute($stid);
