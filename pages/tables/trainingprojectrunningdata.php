...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Tables
        <small>Training Running Project</small>
      </h1>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php  
                    $q="SELECT Proj_Training.P_Id,Project.P_Name,Project.City,Project.Start_Date,Project.Budget,Project.P_Fund  FROM Project,Proj_Training WHERE Project.P_Id=Proj_Training.P_Id AND Project.End_Date=to_date('01/01/2070','dd/mm/yyyy')";
