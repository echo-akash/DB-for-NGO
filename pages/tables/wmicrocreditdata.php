            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT W_Micro_Credit.P_Id,Project.P_Name,Project.City,Project.Start_Date,Project.Budget,Project.P_Fund  FROM Project,W_Micro_Credit WHERE Project.P_Id=W_Micro_Credit.P_Id');
                    oci_execute($stid);
