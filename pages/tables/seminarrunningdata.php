...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Tables
        <small>Running Seminar Projects</small>
      </h1>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php  
                    $q = "SELECT Women_Emp_Seminar.P_Id,Project.P_Name,Project.City,Project.Start_Date,Project.Budget,Project.P_Fund  FROM Project,Women_Emp_Seminar WHERE Project.P_Id=Women_Emp_Seminar.P_Id AND Project.End_Date=to_date('01/01/2070','dd/mm/yyyy') ";
