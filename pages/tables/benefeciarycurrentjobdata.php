...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Tables
        <small>Beneficiary Current Job</small>
      </h1>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Number of workers at office</th>
                  <th>Joining Date</th>
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT concat(INITCAP(F_name),INITCAP(L_Name)),TYPE,MONTHY_INCOME,NO_OF_WORKER,START_DT,OFFICE_ADDR FROM CURRENT_JOB,Person WHERE Person.Person_Id=CURRENT_JOB.Person_Id');
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
