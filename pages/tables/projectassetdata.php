            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $stid = oci_parse($connection, 'SELECT P_Name,Asset_Type,Buying_Date,Quantity,Total_Price FROM Assets,Project_Asset,Project WHERE Assets.Asset_Id=Project_Asset.Asset_Id AND Project.P_Id=Project_Asset.P_Id');
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
