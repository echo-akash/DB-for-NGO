...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="donarupdate_input.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Donar.Person_Id) FROM Person,Donar WHERE Person.Person_Id=Donar.Person_Id');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT Donar.Person_Id,concat(Person.F_Name,Person.L_Name) FROM Person,Donar WHERE Person.Person_Id=Donar.Person_Id');
                    oci_execute($stid);
