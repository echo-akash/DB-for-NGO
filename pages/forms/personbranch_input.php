...
<head>
  ...
  <title>Person Branch Assignment</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="personbranchinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <option>(--Not Selected--)</option>  
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Person_Id) FROM Employee');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT Employee.Person_Id,concat(F_Name,L_Name) FROM Person,Employee WHERE Person.Person_Id=Employee.Person_Id');
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
