      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="referencedata_delete.php" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Ref_relation.Ref_id) FROM Ref_relation');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT Ref_relation.Ref_id,Ref_relation.Ref_name FROM Ref_relation');
                    oci_execute($stid);
