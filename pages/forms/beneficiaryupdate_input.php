...
<head>
  ...
  <title>Beneficiary Data Update</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="beneficiaryupdateinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  $q="SELECT Person_Id FROM Beneficiaries WHERE Person_Id='$Ck_Personid'";
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Beneficiary Extra Information</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Physical Limitation</label>
                  <?php
                    
                  $q="SELECT Limitations FROM Beneficiaries WHERE Person_Id='$Ck_Personid'";
                  $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {

                        echo "<input type='text' class='form-control' name='BeneficiaryPhysicalLimitation' id='BeneficiaryPhysicalLimitation' placeholder='Enter Physical Limitation of Beneficiary' value='".$row[0]. "'>"; 

                    }
                    oci_free_statement($stid);
                    ?>
            <!--      <input type="text" class="form-control" name="BeneficiaryPhysicalLimitation" id="BeneficiaryPhysicalLimitation" placeholder="Enter Physical Limitation of Beneficiary">-->
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Present Status</label>
                  <?php
                    
                  $q="SELECT Present_status FROM Beneficiaries WHERE Person_Id='$Ck_Personid'";
                  $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {

                        echo "<input type='text' class='form-control' name='BeneficiaryPresentStatus' id='BeneficiaryPresentStatus' placeholder='Enter Physical Limitation of Beneficiary' value='".$row[0]. "'>"; 

                    }
                    oci_free_statement($stid);
                    ?>
            <!--      <input type="text" class="form-control" name="BeneficiaryPresentStatus" id="BeneficiaryPresentStatus" placeholder="Enter Present Status">-->
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Blood Pressure</label>
                  <?php
                    
                  $q="SELECT Blood_Pressure FROM Beneficiaries WHERE Person_Id='$Ck_Personid'";
                  $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {

                        echo "<input type='text' class='form-control' name='BeneficiaryBloodPressure' id='BeneficiaryBloodPressure' placeholder='Enter Blood Pressure' value='".$row[0]. "'>"; 

                    }
                    oci_free_statement($stid);
                    ?>
            <!--      <input type="text" class="form-control" name="BeneficiaryBloodPressure" id="BeneficiaryBloodPressure" placeholder="Enter Blood Pressure">-->
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Sugar Level</label>
                  <?php
                    
                  $q="SELECT Sugar_Level FROM Beneficiaries WHERE Person_Id='$Ck_Personid'";
                  $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {

                        echo "<input type='text' class='form-control' name='BeneficiarySugarLevel' id='BeneficiarySugarLevel' placeholder='Enter Sugar Level' value='".$row[0]. "'>"; 

                    }
                    oci_free_statement($stid);
                    ?>
            <!--      <input type="text" class="form-control" name="BeneficiarySugarLevel" id="BeneficiarySugarLevel" placeholder="Enter Sugar Level">-->
                </div>
