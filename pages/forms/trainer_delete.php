      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="volunteerdata_delete.php" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Person.Person_Id) FROM Trainer,Person WHERE Trainer.Person_Id=Person.Person_Id');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT (Person.Person_Id),concat(Person.F_Name,Person.L_name) FROM Trainer,Person WHERE Trainer.Person_Id=Person.Person_Id');
                    oci_execute($stid);
