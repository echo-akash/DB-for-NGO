...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="personprojectinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $stid = oci_parse($connection, 'SELECT Person_Id FROM Person');
                    oci_execute($stid);
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $stid = oci_parse($connection, 'SELECT P_Id FROM Project');
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
