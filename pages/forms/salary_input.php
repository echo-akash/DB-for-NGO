...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="salaryinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(UNIQUE(Person.Bank_acct_no)) FROM Person,Employee,Trainer WHERE person.Person_Id=Trainer.person_Id OR Person.Person_Id=Employee.Person_Id');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT UNIQUE(Person.Bank_acct_no),CONCAT(pERSON.f_nAME,Person.L_Name) FROM Person,Employee,Trainer WHERE person.Person_Id=Trainer.person_Id OR Person.Person_Id=Employee.Person_Id');
                    oci_execute($stid);
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="BeneficiaryFirstName" id="BeneficiaryFirstName" placeholder="Enter Bonus Amount">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Bonus Date</label>
                  <input type="Date" class="form-control" name="BDate" id="BDate" placeholder="Enter Bonus Date">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Bonus Name</label>
                  <input type="text" class="form-control" name="BName" id="BName" placeholder="Enter Bonus Name">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Basic Pay</label>
                  <input type="number" class="form-control" name="BPay" id="BPay" placeholder="Enter Basic Pay">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">House Alliance</label>
                  <input type="number" class="form-control" name="HA" id="HA" placeholder="Enter House Alliance">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Utshob Alliance</label>
                  <input type="number" class="form-control" name="UA" id="UA" placeholder="Enter Utshob Alliance">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Government Tax</label>
                  <input type="number" class="form-control" name="tax" id="tax" placeholder="Enter Government Tax">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Medical Alliance</label>
                  <input type="number" class="form-control" name="ma" id="ma" placeholder="Enter Medical Alliance">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Providance Fund Cutting</label>
                  <input type="number" class="form-control" name="pfc" id="pfc" placeholder="Enter Providance Fund Cutting">
                </div>
