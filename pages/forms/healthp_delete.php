      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="healthpdata_delete.php" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Project.P_Id) FROM Project,Health_Proj WHERE Project.P_Id=Health_Proj.P_Id');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT Project.P_Id,Project.P_Name FROM Project,Health_Proj WHERE Project.P_Id=Health_Proj.P_Id');
                    oci_execute($stid);
