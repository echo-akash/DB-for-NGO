...
$isql1="UPDATE Women_Emp_Seminar SET Seminar_Subj='$Beneficiary_Weight',Chief_Guest='$Beneficiary_Height',Special_Guest='$Beneficiary_Height1' WHERE P_Id='$Beneficiary_IDNumber'";
