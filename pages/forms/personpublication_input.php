...
<head>
  ...
  <title>Person Project Assignment</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="personpublicationinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="CkPersonid" id="CkPersonid" class="form-control select2" style="width: 100%;">
                  ...
                  else
                  {
                    ...
                    $stid = oci_parse($connection, 'SELECT Person_Id,concat(F_Name,L_Name) FROM Person');
                    oci_execute($stid);
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Project Identification</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
