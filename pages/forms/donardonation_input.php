...
<head>
  ...
  <title>Donar Donation Input</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="donardonationinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Donar Donation Information</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <option>(--Not Selected--)</option>  
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Person_Id) FROM Donar');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT Donar.Person_Id,concat(F_Name,L_Name) FROM Person,Donar WHERE Person.Person_Id=Donar.Person_Id');
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
                ...
                <div class="form-group">
                  <label>Donar Type</label>
                  <select class="form-control" name="DonarType" id="DonarType">
              ...
              <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="DA" id="DA" placeholder="Enter Donation Amount">
              </div>
               <div class="form-group">
                  <label for="exampleInputEmail1">Date of Donation</label>
                  <input type="Date" class="form-control" name="DoD" id="DoD" placeholder="Enter Donating date">
               </div>
