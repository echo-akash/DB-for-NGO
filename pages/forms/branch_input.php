...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="branchinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="BeneficiaryFirstName" id="BeneficiaryFirstName" placeholder="Enter Branch Name" required>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Office Fund</label>
                  <input type="number" class="form-control" name="BeneficiaryNationality" id="BeneficiaryNationality" placeholder="Enter Office Fund" required>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Branch Senior Officer name</label>
                  <input type="text" class="form-control" name="BeneficiaryNationality1" id="BeneficiaryNationality" placeholder="Enter Branch Senior Officer Name" required>
                </div>
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="Email" class="form-control" name="BeneficiaryEmailID" id="BeneficiaryEmailID" placeholder="Enter Email ID" required>
                </div>
                <div class="form-group">
