...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="beneficiaryinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="BeneficiaryPhoneNumber" id="BeneficiaryPhoneNumber" placeholder="Enter Phone Number" required>
                </div>
                <div class="form-group">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="BeneficiaryPresentStatus" id="BeneficiaryPresentStatus" placeholder="Enter Present Status" required>
              </div>
              <div class="form-group">
