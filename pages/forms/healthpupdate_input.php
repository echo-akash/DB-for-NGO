...
<head>
  ...
  <title>Health Project Data Update</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="healthpupdateinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  $q="SELECT P_Id FROM Health_Proj WHERE P_Id='$Ck_Personid'";
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Given Service</label>
                  <?php
                    
                  $q="SELECT Given_service FROM Health_Proj WHERE P_Id='$Ck_Personid'";
                  $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
            ...
            <!--      <input type="text" class="form-control" name="BeneficiaryWeight" id="BeneficiaryWeight" placeholder="Enter Weight in KG">-->
                ...
                <div class="form-group">
                  ...
                  $q="SELECT Donated_mat FROM Health_Proj WHERE P_Id='$Ck_Personid'";
                  $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
            ...
            <!--      <input type="text" class="form-control" name="BeneficiaryHeight" id="BeneficiaryHeight" placeholder="Enter height in Inches">-->
                ...
                <div class="form-group">
                  ...
                  $q="SELECT Amount_mat FROM Health_Proj WHERE P_Id='$Ck_Personid'";
                  $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
