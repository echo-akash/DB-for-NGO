...
<head>
  ...
  <title>Project Asset Assignment</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="projectassetinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Asset Identification</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Asset_Id) FROM Assets');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT Asset_Id,Asset_Type FROM Assets');
                    oci_execute($stid);
