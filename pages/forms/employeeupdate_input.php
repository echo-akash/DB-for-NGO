...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="employeeupdateinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  $q="SELECT Person_Id FROM Employee WHERE Person_Id='$Ck_Personid'";
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Employee Extra Information</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  $q="SELECT End_Date FROM Employee WHERE Person_Id='$Ck_Personid'";
                  $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {

                        echo "<input type='date' class='form-control' name='BeneficiaryPhysicalLimitation' id='BeneficiaryPhysicalLimitation' placeholder='Enter Physical Limitation of Beneficiary' value='".$row[0]. "'>"; 
            ...
            <!--      <input type="text" class="form-control" name="BeneficiaryPhysicalLimitation" id="BeneficiaryPhysicalLimitation" placeholder="Enter Physical Limitation of Beneficiary">-->
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Present Rank/Position</label>
                  <?php
                    
                  $q="SELECT Position_rank FROM Employee WHERE Person_Id='$Ck_Personid'";
                  $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
