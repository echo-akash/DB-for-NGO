...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="seminarpupdate_input.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Select Seminar Project</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Women_Emp_Seminar.P_Id) FROM Project,Women_Emp_Seminar WHERE Project.P_Id=Women_Emp_Seminar.P_Id');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT Women_Emp_Seminar.P_Id,Project.P_name FROM Project,Women_Emp_Seminar WHERE Project.P_Id=Women_Emp_Seminar.P_Id');
                    oci_execute($stid);
