              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Person.Person_Id) FROM Donar,Person WHERE Donar.Person_Id=Person.Person_Id');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT (Person.Person_Id),concat(Person.F_Name,Person.L_name) FROM Donar,Person WHERE Donar.Person_Id=Person.Person_Id');
                    oci_execute($stid);
