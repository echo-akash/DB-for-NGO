...
$isql1="UPDATE Beneficiaries SET Limitations='$Beneficiary_PhysicalLimitation',Present_status='$Beneficiary_PresentStatus',Blood_Pressure='$Beneficiary_BloodPressure',Sugar_Level='$Beneficiary_SugarLevel' WHERE Person_Id='$Beneficiary_IDNumber'";
