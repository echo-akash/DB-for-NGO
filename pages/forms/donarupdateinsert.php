...
$Donation_Type1 = $_POST['DonationType1'];
$Beneficiary_PresentStatus = date('m/d/y', strtotime($_POST['BeneficiaryPresentStatus']));
...
*/
/*
$isql1="UPDATE Donar SET Type_of_Donar='$Donar_Type',Donation_Type='$Donation_Type1',Donation_Amount='$Beneficiary_PhysicalLimitation',Date_of_Donation=to_date('".$Beneficiary_PresentStatus."','MM/DD/YY') WHERE Person_Id='$Beneficiary_IDNumber'";
*/
/*
