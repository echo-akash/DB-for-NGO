...
<head>
  ...
  <title>Project Expanse Input</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Project Expanse Data Insertion
        <small>Preview</small>
      </h1>
    ...
    <section class="content">
      <form role="form" action="projectexpanseinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(P_Id) FROM Project');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT P_Id,P_Name FROM Project');
                    oci_execute($stid);
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Date of Expenditure</label>
                  <input type="Date" class="form-control" name="BeneficiaryDOB" id="BeneficiaryDOB" placeholder="Enter Date of Expenditure">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">House Rent</label>
                  <input type="text" class="form-control" name="HR" id="HR" placeholder="Enter House Rent">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Electricity</label>
                  <input type="text" class="form-control" name="elec" id="elec" placeholder="Enter Electricity">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Water</label>
                  <input type="text" class="form-control" name="wat" id="wat" placeholder="Enter Water Expanse">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Internet</label>
                  <input type="text" class="form-control" name="internet" id="internet" placeholder="Enter Internet">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Others</label>
                  <input type="text" class="form-control" name="oth" id="oth" placeholder="Enter Others Expanse">
                </div>
