...
$isql1="INSERT INTO Trainer(Person_Id,Join_date,End_Date) VALUES(personid_sequence.currval,to_date('".$Employee_JoinDate."','MM/DD/YY'),to_date('".$Employee_RetireDate."','MM/DD/YY'))";
