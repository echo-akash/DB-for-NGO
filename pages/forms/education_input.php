...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="educationinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Person Identification</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Person_Id) FROM Person');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT concat(F_Name,L_Name),Person_Id FROM Person');
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {

                      for ($i=0,$j=1; $i < $countnum,$j<=$countnum; $i++,$j++) { 
                        echo "<option value='" . $row[$j] ."'>" . $row[$j] .$row[$i]."</option>";
                      }
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="BeneficiaryNID" id="BeneficiaryNID" placeholder="Enter Exam Name">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Passing Year</label>
                  <input type="Date" class="form-control" name="BeneficiaryBirthCertificate" id="BeneficiaryBirthCertificate" placeholder="Enter Passing Year">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Result</label>
                  <input type="text" class="form-control" name="BeneficiaryDrivingLicense" id="BeneficiaryDrivingLicense" placeholder="Enter Result(GPA/CGPA)">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Group</label>
                  <input type="text" class="form-control" name="BeneficiaryPassport" id="BeneficiaryPassport" placeholder="Enter Group">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Board/University</label>
                  <input type="text" class="form-control" name="BeneficiaryTIN" id="BeneficiaryTIN" placeholder="Enter Board/University">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Institute/University</label>
                  <input type="text" class="form-control" name="BeneficiaryWeight" id="BeneficiaryWeight" placeholder="Enter Institute/University">
                </div>                
                <div class="form-group">
                  <label for="exampleInputEmail1">Session</label>
                  <input type="text" class="form-control" name="BeneficiaryHeight" id="BeneficiaryHeight" placeholder="Enter Session">
                </div>  
