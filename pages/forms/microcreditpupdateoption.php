...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="microcreditpupdate_input.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Select Microcredit Project</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(W_Micro_Credit.P_Id) FROM Project,W_Micro_Credit WHERE Project.P_Id=W_Micro_Credit.P_Id');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT W_Micro_Credit.P_Id,Project.P_name FROM Project,W_Micro_Credit WHERE Project.P_Id=W_Micro_Credit.P_Id');
                    oci_execute($stid);
