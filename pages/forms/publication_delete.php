      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="publicationdata_delete.php" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Publication.Pub_Id) FROM Publication');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT Publication.Pub_Id,Publication.Pub_Name FROM Publication');
                    oci_execute($stid);
