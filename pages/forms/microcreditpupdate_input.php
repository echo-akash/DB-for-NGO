...
<head>
  ...
  <title>Microcredit Project Data Update</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Microcredit Project Data Update
        <small>Preview</small>
      </h1>
    ...
    <section class="content">
      <form role="form" action="microcreditpupdateinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  $q="SELECT P_Id FROM W_Micro_Credit WHERE P_Id='$Ck_Personid'";
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Microcredit Project Materials</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  $q="SELECT Num_Installment FROM W_Micro_Credit WHERE P_Id='$Ck_Personid'";
                  $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {

                        echo "<input type='number' class='form-control' name='BeneficiaryWeight' id='BeneficiaryWeight' placeholder='Enter Given Service' value='".$row[0]. "'>"; 
            ...
            <!--      <input type="text" class="form-control" name="BeneficiaryWeight" id="BeneficiaryWeight" placeholder="Enter Weight in KG">-->
                ...
                <div class="form-group">
                  ...
                  $q="SELECT Duration FROM W_Micro_Credit WHERE P_Id='$Ck_Personid'";
                  $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
            ...
            <!--      <input type="text" class="form-control" name="BeneficiaryHeight" id="BeneficiaryHeight" placeholder="Enter height in Inches">-->
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Rate of Credit</label>
                  <?php
                    
                  $q="SELECT Rate FROM W_Micro_Credit WHERE P_Id='$Ck_Personid'";
                  $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {

                        echo "<input type='number' class='form-control' name='BeneficiaryHeight1' id='BeneficiaryHeight1' placeholder='Enter Amount' value='".$row[0]. "'>"; 
            ...
            <!--      <input type="text" class="form-control" name="BeneficiaryHeight" id="BeneficiaryHeight" placeholder="Enter height in Inches">-->
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Total Amount of Credit</label>
                  <?php
                    
                  $q="SELECT Amount FROM W_Micro_Credit WHERE P_Id='$Ck_Personid'";
                  $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {

                        echo "<input type='number' class='form-control' name='BeneficiaryHeight11' id='BeneficiaryHeight11' placeholder='Enter Amount' value='".$row[0]. "'>"; 
