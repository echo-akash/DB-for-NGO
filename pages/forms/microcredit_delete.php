...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Micro Credit Project Data deletion
        <small>Preview</small>
      </h1>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="microcreditpdata_delete.php" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Project.P_Id) FROM Project,W_Micro_Credit WHERE Project.P_Id=W_Micro_Credit.P_Id');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT Project.P_Id,Project.P_Name FROM Project,W_Micro_Credit WHERE Project.P_Id=W_Micro_Credit.P_Id');
                    oci_execute($stid);
