...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="refrelinsert.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="BeneficiaryFirstName" id="BeneficiaryFirstName" placeholder="Enter Name">
                </div>
                <div class="form-group">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="BeneficiaryPC" id="BeneficiaryPC" placeholder="Enter Postal Code">
                </div>
