...
$isql1="INSERT INTO Branch_Expense(Br_Id,ExpTrans_Id) VALUES('$Ck_Personid',exptransid_sequence.currval)";
...
//header('Location:http://localhost/test/DbProject/pages/forms/branchexpanse_input.html');
?>
