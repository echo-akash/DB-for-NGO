...
$isql1="UPDATE Employee SET Position_rank='$Beneficiary_PresentStatus',End_Date=to_date('".$Beneficiary_PhysicalLimitation."','MM/DD/YY') WHERE Person_Id='$Beneficiary_IDNumber'";
