  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="http://localhost/test/DbProject/index.html">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Data Insert</span>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Deletion</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="seminarpdata_delete.php" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Project.P_Id) FROM Project,Women_Emp_Seminar WHERE Project.P_Id=Women_Emp_Seminar.P_Id');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT Project.P_Id,Project.P_Name FROM Project,Women_Emp_Seminar WHERE Project.P_Id=Women_Emp_Seminar.P_Id');
                    oci_execute($stid);
