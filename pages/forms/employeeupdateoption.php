...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="employeeupdate_input.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  else
                  {
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Employee.Person_Id) FROM Person,Employee WHERE Person.Person_Id=Employee.Person_Id');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT Employee.Person_Id,concat(Person.F_Name,Person.L_Name) FROM Person,Employee WHERE Person.Person_Id=Employee.Person_Id');
                    oci_execute($stid);
