  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        <big><b>Health Project general Information</b></big>
        <address>
                  <?php  
      ...
      <div class="col-sm-4 invoice-col">
        ...
        <address>
                  <?php  
                    $E_Id = $_POST['CkPersonid'];
                    $GenVal111 = array("<b>Given Service</b>", "<b>Donated Materials</b>", "<b>Amount of Materials</b>");
                    $count111 = count($GenVal111);
                    $q = " SELECT Given_service,Donated_mat,Amount_mat FROM Health_Proj WHERE P_Id='$E_Id'";
                    $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
