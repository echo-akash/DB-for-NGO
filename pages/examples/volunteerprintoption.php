...
<head>
  ...
  <title>Volunteer Data Print</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form role="form" action="volunteerdataprint.php" method="post">
      <div class="row">
        <!-- left column -->
        <div class="col-md-6">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <option>(--Not Selected--)</option>  
                    ...
                    $countnum = 0;
                    $stid1 = oci_parse($connection, 'SELECT COUNT(Volunteer.Person_Id) FROM Person,Volunteer WHERE Person.Person_Id=Volunteer.Person_Id');
                    oci_execute($stid1);
                    ...
                    $stid = oci_parse($connection, 'SELECT Volunteer.Person_Id,concat(Person.F_Name,Person.L_Name) FROM Person,Volunteer WHERE Person.Person_Id=Volunteer.Person_Id');
                    oci_execute($stid);
