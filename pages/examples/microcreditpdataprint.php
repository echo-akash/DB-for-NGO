  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        <big><b>Microcredit Project general Information</b></big>
        <address>
                  <?php  
      ...
      <div class="col-sm-4 invoice-col">
        ...
        <address>
                  <?php  
                    $E_Id = $_POST['CkPersonid'];
                    $GenVal111 = array("<b>Number of Installments</b>", "<b>Duration</b>", "<b>Rate of Installments</b>", "<b>Amount of Credit</b>");
                    $count111 = count($GenVal111);
                    $q = " SELECT Num_Installment,Duration,Rate,Amount FROM W_Micro_Credit WHERE P_Id='$E_Id'";
                    $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
                      for ($i=0,$j=0; $i<4,$j<$count111; $i++,$j++) {
