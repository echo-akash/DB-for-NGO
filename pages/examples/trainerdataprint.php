  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        <big><b>Trainer general Information</b></big>
        <address>
                  <?php  
                    $E_Id = $_POST['CkPersonid'];
                    $GenVal1 = array("<b>Trainer ID</b>", "<b>First Name</b>", "<b>First Name</b>", "<b>Date of Birth</b>", "<b>Gender</b>", "<b>Religion</b>", "<b>Nationality</b>");
      ...
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        <big><b>Trainer Contact Information</b></big>
        <address>
          <?php  
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        <big><b>Trainer Identification Information</b></big>
        <address>
                  <?php  
                    $E_Id = $_POST['CkPersonid'];
