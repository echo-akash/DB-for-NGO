  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        <big><b>Training Project general Information</b></big>
        <address>
                  <?php  
      ...
      <div class="col-sm-4 invoice-col">
        ...
        <address>
                  <?php  
                    $E_Id = $_POST['CkPersonid'];
                    $GenVal111 = array("<b>Training Type</b>", "<b>Number of Students</b>");
                    $count111 = count($GenVal111);
                    $q = " SELECT T_Type,Student_No FROM Proj_Training WHERE P_Id='$E_Id'";
                    $stid = oci_parse($connection, $q);
                    oci_execute($stid);
                    while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
                      for ($i=0,$j=0; $i<2,$j<$count111; $i++,$j++) {
